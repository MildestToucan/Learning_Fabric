...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        //We're creating a Pool which will make all blocks using it have their textures and models based on
        //the pink garnet block.
        ...
        //^ These three lines instruct the code to differentiate and use the two different lamp textures for dataGen.
    }
    ...
    //These all appear this simple thanks to the fact we named the textures exactly like their corresponding
    //items and blocks.
