...
//Making the ModLootTableProvider constructor matching the super PUBLIC is important.
    ...
    public void generate() {
        ...
        //For single ore drops, the stuff above is enough, but for multiple ore drops per block, we'll put together something
        //inspired by the minecraft vanilla copper ore drop code.
    ...
    //Now we created this custom Method, we can use it to generate the loot table of any ore with multiple drops.
    //The cool thing is we can reuse this in as many mods with compatible DataGen as we want!
